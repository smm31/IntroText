...
Alt + PrtScn (Saves a screenshot of the active window)

Shortcuts I would like to start using:
Ctrl-Z (undos the previous action)
CTRL + Shift + T (to Restore Closed Browser Tabs)
...
```
## More Resources
Check out the [labs/img/links.md](links.md) page for useful links
